...
REWARD_SURVIVAL_EXPONENT="2.0"
REWARD_TURN_DISCOUNT="0.95"
...
for arg in "$@"; do
  case "$arg" in
    ...
    --reward_turn_discount=*) REWARD_TURN_DISCOUNT="${arg#*=}" ;;
...
python3 trainer/gemma_rl_trainer.py \
  ...
  --reward_turn_discount="${REWARD_TURN_DISCOUNT}" \
